...
function [data_cond1, data_cond2] = getSubjAverage(subj, timeStart, timeEnd, component, data_dir)
% added
% subj = 'hc001';
% channel = 'Pz';
% %0.3, 0.8, 'P3'
...
% -------------------------------------------------------------------------
cd('C:\Users\New Owner\Documents\MATLAB\MDD classification ERP\Early_ERP_data')
filename_cond1 = sprintf('%s_%s_avgCond1.mat', subj, component);
filename_cond2 = sprintf('%s_%s_avgCond2.mat', subj, component);
